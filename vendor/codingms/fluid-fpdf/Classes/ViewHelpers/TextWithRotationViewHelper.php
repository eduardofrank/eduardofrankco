 ...
 */
class TextWithRotationViewHelper extends AbstractViewHelper
{
    /**
     * Initialize
     */
    public function initializeArguments(): void
    {
        ...
        $this->registerArgument('textAngle', 'float', 'Text angle.', false, 0.0);
        $this->registerArgument('fontAngle', 'float', 'Font angle.', false, 0.0);
    }
    ...
    public function render(): void
    {
        ...
        $fpdf->TextWithRotation($this->arguments['x'], $this->arguments['y'], $text, $this->arguments['textAngle'], $this->arguments['fontAngle']);
        $this->renderChildren();
    }
}
