<?php
class template_Tags_html_1a9350c062ba5149 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
    public function getOriginalTemplatePath(): ?string {
        return '/var/www/html/vendor/eduardo-frank/efrank14/Resources/Private/Partials/Meta/Elements/Tags.html';
    }
...
$array13 = [
'0' => $renderingContext->getVariableProvider()->getByPath('post.tags'),
];
...
return $renderingContext->getVariableProvider()->getByPath('post.tags');
};
...
$output32 .= '
                <li>
                    <span class="postmetagroup__listitem" data-blog-tag="';

$output32 .= call_user_func_array( function ($var) { if ($var instanceof TYPO3Fluid\Fluid\Core\Parser\UnsafeHTML) { return (string)$var; }return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('postTag.uid')]);

$output32 .= '">
                        <span class="postmetagroup__listtext">';
// Rendering ViewHelper T3G\AgencyPack\Blog\ViewHelpers\Link\TagViewHelper
...
'aria' => NULL,
'rss' => false,
'tag' => $renderingContext->getVariableProvider()->getByPath('postTag'),
];

$output32 .= $renderingContext->getViewHelperInvoker()->invoke(T3G\AgencyPack\Blog\ViewHelpers\Link\TagViewHelper::class, $arguments33, $renderingContext, $renderChildrenClosure34);
...
'reverse' => false,
'iteration' => NULL,
'each' => $renderingContext->getVariableProvider()->getByPath('post.tags'),
'as' => 'postTag',
];
